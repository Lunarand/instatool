...
# ----- REPLACED INPUT WITH ENVIRONMENT VARIABLES -----
TOKEN = os.environ.get('TOKEN')
ID = os.environ.get('CHAT_ID')

if not TOKEN or not ID:
    raise Exception("TOKEN and CHAT_ID environment variables must be set.")

# Suppress clear error in non-interactive shells
try:
    os.system('clear')
except:
    pass
...
print(f"{M}Using Telegram Token from secret...{S}")
print("\x1b[1;39m—" * 60)
print(f"{S}Using Chat ID from secret...{M}")
print("\x1b[1;39m—" * 60)

# Initial telegram message (optional)
try:
